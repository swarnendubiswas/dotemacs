...
We use [[https://github.com/radian-software/straight.el][straight.el]] as the package manager, and the setup should work on most Linux systems. Try the following resolution in case there is an error trying to connect to "raw.githubusercontent.com:443".
